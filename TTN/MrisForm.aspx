...
<div class="v4formContainer">
    <div class="marginL">
        ...
        <div id="OrderPanel" class="predicate_block" runat="server">
            ...
            <v4control:DropDownList ID="efOrder" runat="server" Width="370px" CSSClass="aligned_control" NextControl="btnSave" IsReadOnly="True"/>
        </div>
    ...
    <div id="divRest" style="display: none; text-align: center;">
        <table cellpadding="0" cellspacing="2" border="0" width="100%">
            <tr>
                <td colspan="3">
                    <v4control:DropDownList runat="server" ID="efRestType" Width="230" OnChanged="RestType_Changed"/>
                </td>
            </tr>
            <tr>
                <td colspan="3">
                    <div id="Div1" class="predicate_block">
                        <div class="inline_predicate_block_text">
                            <v4control:CheckBox runat="server" ID="efResourceChild" OnChanged="RestType_Changed"/>
                        </div>
            ...
            <tr>
                ...
                <td nowrap>
                    <v4control:Div id="efBDOst" runat="server" IsReadOnly="true"/>
                </td>
                <td nowrap>
                    <v4control:Div id="efBDUnit" runat="server"/>
                </td>
            </tr>
            <tr>
                <td nowrap><%= Resx.GetString("TTN_lblAtEndDay") %> <v4control:DatePicker id="DateDocE" runat="server" IsReadOnly="true"/>:</td>
                <td nowrap>
                    <v4control:Div id="efEDOst" runat="server" IsReadOnly="true"/>
                </td>
                <td nowrap>
                    <v4control:Div id="efEDUnit" runat="server"/>
                </td>
            </tr>
        </table>
    </div>
