...
<script src="Kesco.Mris.js?v=3" type="text/javascript"></script>
<body>
...
<div class="v4formContainer">
    <div class="marginL">
        ...
        <div id="OrderPanel" class="predicate_block" runat="server">
            ...
            <v4control:DropDownList ID="efOrder" runat="server" Width="370px" CSSClass="aligned_control" NextControl="btnSave" IsReadOnly="True" IsShowEditingStatus="False"/>
        </div>
        ...
        <div id="ResourcePanel" class="predicate_block">
            ...
            <v4dbselect:DBSResource ID="efResource" runat="server" Width="370px" CLID="25" IsAlwaysAdvancedSearch="True" IsAlwaysCreateEntity="True" NextControl="efUnitAdv"
                                    IsRequired="True" CSSClass="aligned_control" OnChanged="Resource_Changed"/>
        </div>
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr id="trEquivalent">
                        ...
                        <td style="PADDING-LEFT: 5px; white-space: nowrap">
                            <div><%= Resx.GetString("lblEquivalent") %>:&nbsp;</div>
                        </td>
                        <td style="white-space: nowrap">
                            <v4control:Div ID="efAdvUnit" runat="server" IsReadOnly="True"/>
                        </td>
                        <td style="white-space: nowrap">
                            <v4control:Div ID="efMCoef" runat="server" IsReadOnly="True"/>
                        </td>
                        <td style="white-space: nowrap">
                            <v4control:Div ID="efOsnUnit" runat="server" IsReadOnly="True"/>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <div id="RestPanel" class="predicate_block" runat="server"> 
            <hr/>    
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td>
                        <v4control:DropDownList runat="server" ID="efRestType" Width="230" OnChanged="RestType_Changed" IsNoModifying="True"/>
                    </td>
                    <td rowspan="2">
                        <table cellpadding="0" cellspacing="2" border="0" width="100%">
                            <tr>
                                <td nowrap="nowrap"><%= Resx.GetString("TTN_lblAtBeginningDay") %> <v4control:DatePicker id="efDateDocB" runat="server" IsReadOnly="true"/>:
                                <v4control:TextBox id="efBDOst" runat="server" IsReadOnly="true"/>
                                <v4control:TextBox id="efBDUnit" runat="server" IsReadOnly="true"/></td>
                            </tr>
                            <tr>
                                <td nowrap="nowrap"><%= Resx.GetString("TTN_lblAtEndDay") %> <v4control:DatePicker id="DateDocE" runat="server" IsReadOnly="true"/>:
                                <v4control:TextBox id="efEDOst" runat="server" IsReadOnly="true"/>
                                <v4control:TextBox id="efEDUnit" runat="server" IsReadOnly="true"/></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                <tr>
                    <td>
                        <div id="Div1" class="predicate_block">
                            <div class="inline_predicate_block_text">
                                <v4control:CheckBox runat="server" ID="efResourceChild" OnChanged="RestType_Changed" IsNoModifying="True"/>
                            </div>
