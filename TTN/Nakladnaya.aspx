...
<head runat="server">
    ...
    <script src="Kesco.Nakladnaya.js" type="text/javascript"></script>
...
<div class="spacer"></div>
<div class="v4formContainer">
    <div class="predicate_block" id="divCorrectable"><!--Документ корректировочный-->
        <div class="marginL">
    ...
    <div class="predicate_block" id="div2"><!--Документ корректировочный-->
        <div class="marginL">
            <div id="CorrectingSequel"><%=RenderCorrectingDoc()%></div>
        </div>
    </div>

    <div id="tabs">
      <ul>
        <li id="tabs1"><a href="#tabs-1"><nobr>&nbsp;<IMG src="/styles/DocMain.gif" align=absMiddle/>&nbsp;<%=Resx.GetString("TTN_lblInvoiceDetail")%></nobr></a></li>
        <li id="tabs2"><a href="#tabs-2"><nobr>&nbsp;<IMG src="/styles/Resource.gif" align=absMiddle/>&nbsp;<%:SectionTitles.Resource%></nobr></a></li>
        <li id="tabs3"><a href="#tabs-3"><nobr>&nbsp;<IMG src="/styles/Service.gif" align=absMiddle/>&nbsp;<%:SectionTitles.Services%></nobr></a></li>
      </ul>
      <div id="tabs-1">
        <div id="accordion">
            <!--Данные накладной-->
            ...
            <div>
                ...
                <div class="area_block" id="divNotes"><!--Примечание для печатных форм-->
                    <div class="label"><%: FieldLabels[Notes] %><br/><span style="font-size: 7pt">(<%=Resx.GetString("lblPrnDescription")%>)</span></div>
            ...
            <div>
                <div class="predicate_block" id="divShipperToGo" runat="server"><!--Совпадает-->
                ...
                <v4dbselect:DBSTransportNode ID="DispatchPoint" runat="server" NextControl="GoNotes"
                    Width="380px" CSSClass="aligned_control" AutoSetSingleValue="True"></v4dbselect:DBSTransportNode>
                </div>
                ...
                <div class="label" ><%:FieldLabels[GoInfo]%>
                    <a href="#" onclick="cmd('cmd', 'GetContact', 'Type', 'Go'); "><img id="imgGoAddress" runat="server" border="0" src="/styles/contact.gif" alt="выбрать адрес отличный от юридического"/></a>
                </div>
                ...
                AutoSetSingleValue="True" CSSClass="aligned_control"></v4dbselect:DBSStore>
                </div>
            ...
            <div>
                <div class="predicate_block" id="divPayerToGp" runat="server"><!--Совпадает-->
                ...
                <div class="predicate_block"><!--Пункт назначения-->
                ...
                <div class="label" ><%:FieldLabels[GpInfo]%>
                    <a href="#" onclick="cmd('cmd', 'GetContact', 'Type', 'Gp'); "><img id="imgGpAddress" runat="server" border="0" src="/styles/contact.gif" alt="выбрать адрес отличный от юридического"/></a>
                </div>
            ...
            <div>
                <div class="predicate_block" id="divGoToShipper" runat="server"><!--Совпадает-->
                ...
                <div class="label" ><%:FieldLabels[ShipperAddress]%>
                    <a href="#" onclick="cmd('cmd', 'GetContact', 'Type', 'Shipper'); "><img id="imgShipperAddress" runat="server" border="0" src="/styles/contact.gif" alt="выбрать адрес отличный от юридического"/></a>
                </div>
                <v4control:TextBox ID="ShipperAddress" runat="server" IsReadonly="true" Width="370px" NextControl="ShipperStore"></v4control:TextBox>
                </div>
                
                <div id="ShipperInfoPanel" class="predicate_block" style="display: none"><!--Название поставщика-->
                ...
                <fieldset style="padding: 10px;">
                    <legend style="margin-left:20px;padding:5px; left: 5px;"><%:SectionTitles.SignersOfPaper%></legend>
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr><!--Руководитель-->
                            <td width="185px"><%:FieldLabels[Director]%>
                                <div id="divDirector" class="inline_predicate_block">
                                    <a href="#" onclick="cmd('cmd', 'GetPerson', 'Type', 'Director'); "><img id="imgDirector" border="0" src="/styles/User.gif" alt="выбрать сотрудника"/></a>
                                </div>
                                <div id="divDirectorDelete" class="inline_predicate_block">
                                    <div id="divDD" class="inline_predicate_block">
                                        <a href="#" onclick="cmd('cmd', 'DeletePerson', 'Type', 'Director'); "><img id="imgDirectorDelete" border="0" src="/styles/delete.gif" alt="удалить сотрудника"/></a>
                                    </div>
                                </div>
                            </td>
                            <td width="200px"><v4control:TextBox ID="Director" Width="200px" runat="server" IsReadOnly="True" CSSClass="aligned_control"/></td>
                            <td width="200px"><%:FieldLabels[DirectorPosition]%></td>
                            <td width="300px"><v4control:TextBox ID="DirectorPosition" Width="200px" runat="server" IsReadonly="true" CSSClass="aligned_control"/></td>
                        </tr>
                        <tr>
                            <td colspan="4"><br/></td>
                        </tr>
                        <tr><!--Бухгалтер-->
                            <td width="185px"><%:FieldLabels[Accountant]%>
                                <div id="divAccountant" class="inline_predicate_block">
                                    <a href="#" onclick="cmd('cmd', 'GetPerson', 'Type', 'Accountant'); "><img id="imgAccountant" border="0" src="/styles/User.gif" alt="выбрать сотрудника"/></a>
                                </div>
                                <div id="divAccountantDelete" class="inline_predicate_block">
                                    <div id="divAD" class="inline_predicate_block">
                                        <a href="#" onclick="cmd('cmd', 'DeletePerson', 'Type', 'Accountant'); "><img id="imgAccountantDelete" border="0" src="/styles/delete.gif" alt="удалить сотрудника"/></a>
                                    </div>
                                </div>
                            </td>
                            <td width="200px"><v4control:TextBox ID="Accountant" Width="200px" runat="server" IsReadOnly="True" CSSClass="aligned_control"/></td>
                            <td width="200px"><%:FieldLabels[AccountantPosition]%></td>
                            <td width="300px"><v4control:TextBox ID="AccountantPosition" Width="200px" runat="server" IsReadonly="true" CSSClass="aligned_control"/></td>
                        </tr>
                        <tr>
                            <td colspan="4"><br/></td>
                        </tr>
                        <tr><!--Отпуск груза произвел-->
                            <td width="185px"><%:FieldLabels[StoreKeeper]%>
                                <div id="divStoreKeeper" class="inline_predicate_block">
                                    <a href="#" onclick="cmd('cmd', 'GetPerson', 'Type', 'StoreKeeper'); "><img id="imgStoreKeeper" border="0" src="/styles/User.gif" alt="выбрать сотрудника"/></a>
                                </div>
                                <div id="divStoreKeeperDelete" class="inline_predicate_block">
                                    <div id="divSD" class="inline_predicate_block">
                                        <a href="#" onclick="cmd('cmd', 'DeletePerson', 'Type', 'StoreKeeper'); "><img id="imgStoreKeeperDelete" border="0" src="/styles/delete.gif" alt="удалить сотрудника"/></a>
                                </div>
                                </div>
                            </td>
                            <td width="200px"><v4control:TextBox ID="StoreKeeper" Width="200px" runat="server" IsReadOnly="True" CSSClass="aligned_control"/></td>
                            <td width="200px"><%:FieldLabels[StoreKeeperPosition]%></td>
                            <td width="300px"><v4control:TextBox ID="StoreKeeperPosition" Width="200px" runat="server" IsReadonly="true" CSSClass="aligned_control"/></td>
                        </tr>
                    </table>
                </fieldset>
            </div>
            ...
            <div>
                <div class="predicate_block" id="divGpToPayer" runat="server"><!--Совпадает-->
                ...
                <div class="predicate_block"><!--Адрес-->
                <div class="label" ><%:FieldLabels[PayerAddress]%>
                    <a href="#" onclick="cmd('cmd', 'GetContact', 'Type', 'Payer'); "><img id="imgPayerAddress" runat="server"  border="0" src="/styles/contact.gif" alt="выбрать адрес отличный от юридического"/></a>
                </div>
                <v4control:TextBox ID="PayerAddress" runat="server" IsReadonly="true" Width="370px" NextControl="PayerStore"></v4control:TextBox>
                </div>

                <div id="PayerInfoPanel" class="predicate_block" style="display: none"><!--Название плательщика-->
                ...
                <div id="PayerCodePanel" class="predicate_block" style="display: none"><!--ОКПО плательщика-->
            ...
            <div>
                ...
                AutoSetSingleValue="True" CSSClass="aligned_control" OnChanged="Contract_Changed" OnBeforeSearch="Document_BeforeSearch" IsAdvIcons="True"></v4dbselect:DBSDocument>
                </div>
                ...
                <div class="predicate_block" id="divEnclosure"><!--Приложение-->
                ...
                <div class="predicate_block" id="divApplicationForPurchasing"><!--Заявка на покупку-->
                ...
                <div class="predicate_block" id="divLetterOfCredit"><!--Аккредитив-->
                ...
                <div class="predicate_block" id="divBillOfLading"><!--Коносамент-->
                ...
                <div class="predicate_block" id="divInvoice"><!--Счет, инвойс, проформа-->
                ...
                OnChanged="Invoice_ValueChanged" OnDeleted="Invoice_ValueDeleted" CSSClass="aligned_control" OnBeforeSearch="Document_BeforeSearch"></v4dbselect:DBSDocument>
                </div>

                <div class="predicate_block" id="divPaymentDocuments"><!--Платежные документы-->
                ...
                OnChanged="PaymentDocuments_ValueChanged" OnDeleted="PaymentDocuments_ValueDeleted" CSSClass="aligned_control" OnBeforeSearch="Document_BeforeSearch"></v4dbselect:DBSDocument>
                </div>
            </div>
            <!--Транспорт-->
            <div class="non_correctable_block" id="divTransport"><span><b><%:SectionTitles.Transport%></b></span><div id="TransportTitle" class="headerTitle"></div></div>
            <div>
                <div class="predicate_block" id="divPowerOfAttorney" runat="server"><!--Доверенность-->
                ...
                <div class="predicate_block" id="divDriver" runat="server"><!--Водитель-->
                ...
                <div class="predicate_block" id="divCar" runat="server"><!--Автомобиль-->
                ...
                <div class="predicate_block" id="divCarNumber" runat="server"><!--Номер автомобиля-->
                ...
                <div class="predicate_block" id="divTrailerNumber" runat="server"><!--Номер прицепа-->
                ...
                <div class="predicate_block" id="divCarTtn" runat="server"><!--Транспортная накладная-->
    ...
    <div id="tabs-2">
        ...
        <div id="MrisButtonPanel" class="predicate_block" runat="server">
            ...
            <v4control:Button ID="selectVagon" runat="server"></v4control:Button>
        </div>
...
<div class="marginA" id="itogTable" runat="server">
    ...
    <tr id="trProduct" runat="server">
        ...
        <td class="itogtable"><span id="mrisSum"></span></td>
        <td class="itogtable"><span id="mrisSumNDS"></span></td>
        <td class="itogtable"><span id="mrisSumAll"></span></td>
    </tr>
    <tr id="trServices" runat="server">
        <td class="itogtable" style="background-color:#ededed"><%=Resx.GetString("lblServices")%>:</td>
        <td class="itogtable"><span id="factUslSum"></span></td>
        <td class="itogtable"><span id="factUslSumNDS"></span></td>
        <td class="itogtable"><span id="factUslSumAll"></span></td>
    </tr>
    <tr id="trTotal" runat="server">
        <td class="itogtable" style="background-color:#ededed"><%=Resx.GetString("lTotal")%>:</td>
        <td class="itogtable"><span id="AllSum"></span></td>
        <td class="itogtable"><span id="AllNDSSum"></span></td>
        <td class="itogtable"><span id="AllAllSum"></span></td>
    </tr>
    </table>
</div>
</div>
...
<div class="spacer"></div>
<div class="marginA">
    <csld:LinkedDoc runat="server" ID="LinkedDocs"/>
</div>
<br/>
<br/>
<br/>
...
<div id="divServiceAdd" style="display: none; padding: 2px 0 0 0;">
    <div class="v4DivTable" id="divServiceProgressBar" style="display: none; padding-top: 150px; width: 100%; height: 100%; position: absolute">
        <div class="v4DivTableRow">
...
<div id="divSelectVagon" style="display: none; padding: 2px 0 0 0;">
    <div class="v4DivTable" id="divVagonProgressBar" style="display: none; width: 100%; height: 100%; position: absolute">
        <div class="v4DivTableRow">
            <div class="v4DivTableCell">
                <img src="/styles/ProgressBar.gif" alt="wait"/><br/><%=Resx.GetString("lblWait")%>...
            </div>
...
<div id="divDistribDoc" style="display: none; padding: 2px 0 0 0;">
    <div class="v4DivTable" id="divDistribProgressBar" style="display: none; width: 100%; height: 100%; position: absolute">
        <div class="v4DivTableRow">
            <div class="v4DivTableCell">
...
<div id="divAddress" style="display: none;">
    ...
    <table cellspacing="0" cellpadding="5" border="0">
        <tr>
            ...
            <td><v4dbselect:DBSPerson ID="DBSGOPerson" runat="server" Width="200px" ></v4dbselect:DBSPerson>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <v4dbselect:DBSPersonContact ID="DBSContact" runat="server" IsAlwaysAdvancedSearch="True" NextControl="tbFace"
                    Width="370px" CSSClass="aligned_control"></v4dbselect:DBSPersonContact>
            </td>
        </tr>
    </table>
</div>
...
<div id="divSigner" style="display: none;">
    <table>
        <tr>
            <td><v4control:TextBox ID="tbPerson" runat="server" IsReadonly="true" NextControl="tbPerson"/></td>
            <td><v4dbselect:DBSPerson ID="DBSPerson" runat="server" Width="180px" CLID="4" IsAlwaysAdvancedSearch="True" NextControl="DBSPosition"
                IsCaller="True" CallerType="Person" AutoSetSingleValue="True" CSSClass="aligned_control" OnChanged="Person_Changed"></v4dbselect:DBSPerson>
            </td>
        </tr>
        <tr>
            <td><v4control:TextBox ID="tbPosition" runat="server" IsReadonly="true" NextControl="tbPerson"/></td>            
            <td><v4dbselect:DBSPersonSigner ID="DBSPosition" runat="server" Width="180px" CLID="4" IsAlwaysAdvancedSearch="True" NextControl="DBSPerson"
                AutoSetSingleValue="True" CSSClass="aligned_control" OnChanged="Position_Changed"></v4dbselect:DBSPersonSigner>
            </td>
        </tr>
    </table>
</div>
