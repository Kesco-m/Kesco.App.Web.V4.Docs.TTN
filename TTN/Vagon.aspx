...
<body>
<div class="marginL"><%=RenderHeader()%></div>    
    <div class="v4formContainer">
        <div class="marginL">
                
            <div id="Div2" class="predicate_block">
                <div class="label"><%=Resx.GetString("lblShipperStore")%>:</div>
                <v4dbselect:DBSStore ID="efShipperStore" runat="server" Width="300px" CLID="18" IsAlwaysAdvancedSearch="True" NextControl="efPayerStore"
            ...
            <div id="SumPanel" class="predicate_block">
                ...
                <div class="inline_predicate_block_left">
                    ...
                    <v4dbselect:DBSStavkaNDS ID="efNDS" Width="100px" CSSClass="aligned_control" runat="server" IsRequired="True" NextControl="efShipperStore"/>
                </div>
            </div>
